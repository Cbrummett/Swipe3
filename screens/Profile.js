      ...
      <View>
        <View style={styles.postBackGround}>
          ...
          <View style={styles.buttonRow}>
            <Pressable  style={styles.postButton} onPress={() => navigation.navigate("Comments", {
                loggedInUserID: loggedInUserID,
                postID: item.id
              })} > 
              <Text style={styles.text}>View All Comments</Text>
            </Pressable>
            <Pressable  style={styles.postButton} onPress={() => navigation.navigate("Delete Post", {
                loggedInUserID: loggedInUserID,
                postID: item.id
              })} > 
      ...
      ListHeaderComponent={() => {
        return(
          <View>
            ...
            />
            <View style={styles.buttonRow}>
            <Pressable style={styles.smallButton} onPress={() => navigation.replace("EditProfile", {
              loggedInUserID: loggedInUserID
              })} >
              <Text style={styles.text}>Edit Bio</Text>
            </Pressable>
            <Pressable style={styles.smallButton} onPress={() => navigation.replace("ChangePassword", {
              loggedInUserID: loggedInUserID
              })} >
            ...
            <Text style={styles.postsLabel}>{loggedInUser.username}'s Posts</Text>
          </View>
        )
      }}
      ListFooterComponent={() => {
